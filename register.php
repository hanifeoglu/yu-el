<?php
//SendGrid için gerekli olan import
...
// create the user
        if($user->create()){
            ...
            $htmlContent="Hi {$TO_EMAIL}.<br /><br />";
            $htmlContent.="Please click the following link to verify your email and login: {$home_url}verify/?access_code={$access_code}";
            $subject="Verification Email";

            if($utils->sendEmailViaPhpMail($TO_EMAIL, $subject, $htmlContent)){
